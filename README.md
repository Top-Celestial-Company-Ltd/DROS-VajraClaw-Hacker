...
[Read the full Performance Benchmark Report](docs/PERFORMANCE_BENCHMARK.md)

## 🚀 Quick Start (Demo)
1. Ensure you have Python installed. Install dependencies: `pip install -r requirements.txt`.
